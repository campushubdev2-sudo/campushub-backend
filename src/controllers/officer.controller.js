...
class OfficerController {
  ...
  createOfficer = asyncHandler(async (req, res) => {
    const officer = await officerService.createOfficer(/** @type {AuthenticatedRequest} */ (req).user.id, req.body);
  ...
  getOfficers = asyncHandler(async (req, res) => {
    const result = await officerService.getOfficers(/** @type {AuthenticatedRequest} */ (req).user.id, req.query);
  ...
  getOfficerById = asyncHandler(async (req, res) => {
    const officer = await officerService.getOfficerById(/** @type {AuthenticatedRequest} */ (req).user.id, req.params);
  ...
  updateOfficer = asyncHandler(async (req, res) => {
    const { id } = req.params;
    const result = await officerService.updateOfficer(/** @type {AuthenticatedRequest} */ (req).user.id, id, req.body);
  ...
  deleteOfficer = asyncHandler(async (req, res) => {
    const result = await officerService.deleteOfficerById(/** @type {AuthenticatedRequest} */ (req).user.id, req.params);
  ...
  getOfficerStats = asyncHandler(async (req, res) => {
    const result = await officerService.getOfficerStats(/** @type {AuthenticatedRequest} */ (req).user.id);
  ...
  getOfficersByPeriod = asyncHandler(async (req, res) => {
    const result = await officerService.getOfficersByPeriod(/** @type {AuthenticatedRequest} */ (req).user.id, req.query);
  ...
  getOfficersDetailed = asyncHandler(async (req, res) => {
    const result = await officerService.getOfficersDetailed(/** @type {AuthenticatedRequest} */ (req).user.id);
  ...
  getOfficersNearTermEnd = asyncHandler(async (req, res) => {
    const result = await officerService.getOfficersNearTermEnd(/** @type {AuthenticatedRequest} */ (req).user.id, req.query);
  ...
  getOrganizationOfficerStats = asyncHandler(async (req, res) => {
    const result = await officerService.getOrganizationOfficerStats(/** @type {AuthenticatedRequest} */ (req).user.id, req.params.orgId);
